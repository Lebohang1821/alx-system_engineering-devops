#!/usr/bin/python3
"""Module containing functions for working with Reddit
"""
import requests


def sort_histogram(histogram={}):
    '''It sorts and prints given histogram.
    '''
...
def count_words(subreddit, word_list, histogram=[], n=0, after=None):
    '''It counts number of times each word in a given wordlist
    occurs in given subreddit.
    '''
    api_headers = {
